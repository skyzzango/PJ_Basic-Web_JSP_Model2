...
<c:if test="${empty requestScope.boardList}">
	<%
		System.out.println("main.jsp: empty List");
				...
				<c:forEach var="board" items="${requestScope.boardList}">
					<div class="card mb-4">
						...
						<div class="card-body">
							...
							<a href="${pageContext.request.contextPath}/board?cmd=board_view&num=${board.num}" class="btn btn-primary">Read More &rarr;</a>
						</div>
						<div class="card-footer text-muted">
							Posted on ${board.writedate} by
							<a href="#">${board.id}</a>
						</div>
					</div>
				</c:forEach>
